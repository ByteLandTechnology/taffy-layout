...
test("cookbook_media-card example 1", async () => {
  ...
  const textContainer = tree.newWithChildren(
    ...
    [
      tree.newLeaf(new Style({ size: { width: "100%", height: 20 } })), // Title placeholder
      tree.newLeaf(new Style({ size: { width: "60%", height: 16 } })), // Subtitle placeholder
    ],
  );
