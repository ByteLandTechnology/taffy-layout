...
test("i18n_zh-CN_advanced_performance example 1", async () => {
...
test("i18n_zh-CN_advanced_performance example 2", async () => {
...
test("i18n_zh-CN_advanced_performance example 3", async () => {
  // ✅ 好
  const tree = new TaffyTree();
...
test("i18n_zh-CN_advanced_performance example 4", async () => {
  // ❌ 如果项目相同则避免
  const tree = new TaffyTree();
  for (let i = 0; i < 1000; i++) {
...
test("i18n_zh-CN_advanced_performance example 5", async () => {
...
test("i18n_zh-CN_advanced_performance example 6", async () => {
  const style = new Style();
  // ✅ 单次调用 = 低开销
  style.set({
    display: Display.Flex,
...
test("i18n_zh-CN_advanced_performance example 7", async () => {
  const tree = new TaffyTree();
...
test("i18n_zh-CN_advanced_performance example 8", async () => {
  const tree = new TaffyTree();
  const node = tree.newLeaf(new Style());
  tree.computeLayout(node, { width: 100, height: 100 });
...
test("i18n_zh-CN_advanced_performance example 9", async () => {
  const tree = new TaffyTree();
