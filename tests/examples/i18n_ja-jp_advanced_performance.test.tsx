...
test("i18n_ja-JP_advanced_performance example 1", async () => {
...
test("i18n_ja-JP_advanced_performance example 2", async () => {
...
test("i18n_ja-JP_advanced_performance example 3", async () => {
  // ✅ 良い
  const tree = new TaffyTree();
...
test("i18n_ja-JP_advanced_performance example 4", async () => {
  // ❌ アイテムが同じ場合は避ける
  const tree = new TaffyTree();
  for (let i = 0; i < 1000; i++) {
...
test("i18n_ja-JP_advanced_performance example 5", async () => {
...
test("i18n_ja-JP_advanced_performance example 6", async () => {
  const style = new Style();
  // ✅ 単一の呼び出し = 低オーバーヘッド
  style.set({
    display: Display.Flex,
...
test("i18n_ja-JP_advanced_performance example 7", async () => {
  const tree = new TaffyTree();
...
test("i18n_ja-JP_advanced_performance example 8", async () => {
  const tree = new TaffyTree();
  const node = tree.newLeaf(new Style());
  tree.computeLayout(node, { width: 100, height: 100 });
...
test("i18n_ja-JP_advanced_performance example 9", async () => {
  const tree = new TaffyTree();
