...
| [StyleProperty](type-aliases/StyleProperty.md)                       | Valid property paths for Style.get() method.                                                                                                                    |
| [StylePropertyArrayValues](type-aliases/StylePropertyArrayValues.md) | Helper type to convert an array of property paths to an array of their value types. Unlike `TupleToStyleValues`, this returns an array type instead of a tuple. |
