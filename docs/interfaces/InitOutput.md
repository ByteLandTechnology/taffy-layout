...
| <a id="taffytree_children"></a> `taffytree_children`                                   | `readonly` | (`a`, `b`) => \[`number`, `number`, `number`, `number`\]      |
...
| <a id="taffytree_getdisjointnodecontextmut"></a> `taffytree_getDisjointNodeContextMut` | `readonly` | (`a`, `b`, `c`) => \[`number`, `number`, `number`, `number`\] |
...
| <a id="taffytree_setchildren"></a> `taffytree_setChildren`                             | `readonly` | (`a`, `b`, `c`, `d`) => \[`number`, `number`\]                |
